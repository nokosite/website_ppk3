    ...
    <header class="bg-transparent absolute top-0 left-0 w-full flex items-center z-10">
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between">
                <!-- Left: Logo -->
                <a href="<?php echo e(route('home')); ?>" class="block py-9 w-12 h-12 bg-no-repeat bg-center bg-contain"
                style="background-image: url(<?php echo e(asset('assets/logo/logo_desa.webp')); ?>);"></a>
                    ...
                    class="hidden lg:block absolute lg:static right-4 top-full lg:top-0 py-5 lg:py-0 bg-white lg:bg-transparent shadow-lg lg:shadow-none rounded-lg lg:rounded-none">
                        <ul class="font-mulish font-semibold capitalize lg:flex">
                                ...
                                <li class="relative group">
                                    ...
                                    class="hidden absolute left-0 mt-2 w-40 bg-white rounded-md shadow-lg">
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li>
                                                <a href="<?php echo e(route('destination.category', $category->slug)); ?>"
                            ...
                            <?php elseif($categories->count() === 1): ?>
                                ...
                                <li class="group">
                                    <a href="<?php echo e(route('destination.category', $categories->first()->slug)); ?>"
                                        class="text-base text-black lg:text-white py-2 mx-8 flex group-hover:text-sky-500">
                                        <?php echo e($categories->first()->name); ?>
        ...
        <div class="container mx-auto px-6 md:px-12 lg:px-24">
            <div class="flex flex-col lg:flex-row justify-between items-center lg:items-start gap-12">
                ...
                <div class="flex items-center space-x-3">
                    <img src="<?php echo e(asset('assets/logo/logo_desa.webp')); ?>" alt="Logo" class="w-16">
...
<?php /**PATH /Users/maheskanoko/Documents/1. File Project/6. File Desa Wisaa Jehem/website_ppk3/resources/views/frontend/layout.blade.php ENDPATH**/ ?>