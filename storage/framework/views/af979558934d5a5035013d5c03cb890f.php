<?php $__env->startSection('content'); ?>
    ...
    <section id="home">
        <div class="relative w-full h-screen bg-no-repeat bg-center bg-cover bg-fixed" style="background-image: url(<?php echo e(asset('assets/bg4.webp')); ?>)">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                ...
                <div class="relative overflow-hidden rounded-2xl shadow-lg group">
                    <img class="h-64 w-full object-cover transition-transform group-hover:scale-110 duration-200"
                        src="<?php echo e(storage_url_safe($destination->gambar)); ?>" alt="Desa Jehem Image 1">
                    <div class="absolute inset-0 flex items-end bg-gradient-to-t from-black/60 to-transparent">
                        <div class="p-4 text-white">
                            <h3 class="text-xl font-bold mb-2"><?php echo e($destination->title); ?></h3>
                            <p><?php echo e($destination->excerpt); ?></p>
                            <div class="mt-4">
                                <a href="<?php echo e(route('destination.show', $destination->slug)); ?>" class="btn bg-white text-black px-4 py-2 rounded-md font-semibold hover:bg-sky-500 hover:text-white transition">
                                    See More</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="w-full px-4">
                <div class="flex flex-wrap items-center justify-center space-x-8 lg:space-x-12">
                    ...
                    <a href="#" class="flex justify-center items-center max-w-[100px] sm:max-w-[120px] mx-4">
                        <img loading="lazy" class="w-full h-auto object-contain" src="<?php echo e(asset('assets/logo/bem.webp')); ?>"
                            alt="Logo Bem">
                    </a>

                    
                    <a href="#" class="flex justify-center items-center max-w-[100px] sm:max-w-[120px] mx-4">
                        <img loading="lazy" class="w-full h-auto object-contain" src="<?php echo e(asset('assets/logo/desa_jehem.webp')); ?>"
                            alt="Logo Desa Jehem">
                    </a>

                    
                    <a href="#" class="flex justify-center items-center max-w-[100px] sm:max-w-[120px] mx-4">
                        <img loading="lazy" class="w-full h-auto object-contain" src="<?php echo e(asset('assets/logo/kampusmerdeka.webp')); ?>"
                            alt="Logo Kampus Merdeka">
                    </a>

                    
                    <a href="#" class="flex justify-center items-center max-w-[100px] sm:max-w-[120px] mx-4">
                        <img loading="lazy" class="w-full h-auto object-contain" src="<?php echo e(asset('assets/logo/kemendikbud.webp')); ?>"
                            alt="Logo Kemendikbud">
                    </a>

                    
                    <a href="#" class="flex justify-center items-center max-w-[100px] sm:max-w-[120px] mx-4">
                        <img loading="lazy" class="w-full h-auto object-contain" src="<?php echo e(asset('assets/logo/logo_ppk.webp')); ?>"
                            alt="Logo PPK">
                    </a>

                    
                    <a href="#" class="flex justify-center items-center max-w-[100px] sm:max-w-[120px] mx-4">
                        <img loading="lazy" class="w-full h-auto object-contain" src="<?php echo e(asset('assets/logo/ppk_ormawa.webp')); ?>"
                            alt="Logo PPK Ormawa">
                    </a>

                    
                    <a href="#" class="flex justify-center items-center max-w-[100px] sm:max-w-[120px] mx-4">
                        <img loading="lazy" class="w-full h-auto object-contain" src="<?php echo e(asset('assets/logo/primu.webp')); ?>"
                            alt="Logo Primu">
                    </a>

                    
                    <a href="#" class="flex justify-center items-center max-w-[100px] sm:max-w-[120px] mx-4">
                        <img loading="lazy" class="w-full h-auto object-contain" src="<?php echo e(asset('assets/logo/logo_desa.webp')); ?>"
                            alt="Logo Desa">
                    </a>
                </div>
            </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div id="galeri-content" class="hidden">
                <div class="columns-1 md:columns-2 lg:columns-3 gap-4 space-y-4">
                    <?php $__currentLoopData = $galleries->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <!-- Menampilkan maksimal 3 foto -->
                    <div class="break-inside-avoid">
                        <img src="<?php echo e(storage_url_safe($gallery->gallery)); ?>" 
                             alt="Galeri Image" 
...
<?php echo $__env->make('frontend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/maheskanoko/Documents/1. File Project/6. File Desa Wisaa Jehem/website_ppk3/resources/views/frontend/home.blade.php ENDPATH**/ ?>